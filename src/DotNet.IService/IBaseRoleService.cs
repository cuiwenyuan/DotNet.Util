...
namespace DotNet.IService
{
    ...
    /// </author> 
    /// </summary>
    public partial interface IBaseRoleService
    {
        /// <summary>
        ...
        /// <param name="userInfo">用户</param>
        /// <param name="roleId">角色主键</param>
        /// <param name="addOrganizations">组织机构主键</param>
        /// <returns>影响行数</returns>
        int AddOrganizationToRole(BaseUserInfo userInfo, string roleId, string[] addOrganizations);
        ...
        /// <returns>数据表</returns>
        DataTable GetRoleUserDataTable(BaseUserInfo userInfo, string systemCode, string roleId, string companyId, string userId, string searchKey, out int recordCount, int pageNo, int pageSize, string orderBy);
