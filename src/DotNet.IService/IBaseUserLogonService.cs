...
namespace DotNet.IService
{
    ...
    /// </author> 
    /// </summary>
    public partial interface IBaseUserLogonService
    {
        /// <summary>
        /// 获取服务器时间
        /// </summary>
        ...
        /// <returns>数据表</returns>
        DataTable GetDataTableByPage(string taskId, BaseUserInfo userInfo, out int recordCount, int pageNo, int pageSize, string whereClause, List<KeyValuePair<string, object>> dbParameters, string order = null);
    }
}