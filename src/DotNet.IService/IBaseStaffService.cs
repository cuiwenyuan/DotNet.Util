...
namespace DotNet.IService
{
    ...
    /// </author> 
    /// </summary>
    public partial interface IBaseStaffService
    {
        /// <summary>
        /// 获取内部通讯录
        /// </summary>
        ...
        /// <returns>数据表</returns>
        DataTable GetAddressDataTableByPage(BaseUserInfo userInfo, string organizationId, string searchKey, out int recordCount, int pageNo = 1, int pageSize = 20, string sort = null);
