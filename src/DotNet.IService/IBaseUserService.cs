...
namespace DotNet.IService
{
    ...
    /// </author> 
    /// </summary>
    public partial interface IBaseUserService
    {
        /// <summary>
        /// 判断字段是否重复
        /// </summary>
        ...
        /// <param name="id">主键</param>
        /// <returns>实体</returns>
        BaseUserContactEntity GetUserContactObject(BaseUserInfo userInfo, int id);
        ...
        /// <param name="id">主键</param>
        /// <returns>实体</returns>
        BaseUserContactEntity GetUserContactObjectByCache(BaseUserInfo userInfo, int id);
        ...
        List<BaseUserEntity> GetListByManager(BaseUserInfo userInfo, string managerUserId);
        ...
        /// <returns></returns>
        bool UserIsInOrganization(BaseUserInfo userInfo, string userId, string organizationName);
