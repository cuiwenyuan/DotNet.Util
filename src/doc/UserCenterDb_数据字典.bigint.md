...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Id | id | 编号 | bigint | 19 |  |  | Y | Y | N |
| 2 | UserCompanyId | userCompanyId | 公司编号 | bigint | 19 |  | 0 | N | N | N |
| 3 | UserSubCompanyId | userSubCompanyId | 子公司编号 | bigint | 19 |  | 0 | N | N | N |
...
| 8 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 12 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 17 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 12 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 16 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 21 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Id | id | 编号 | bigint | 19 |  |  | Y | Y | N |
| 2 | TenantId | tenantId | 租户号 | bigint | 19 |  | 0 | N | N | N |
...
| 9 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 13 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 18 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Id | id | 编号 | bigint | 19 |  |  | Y | Y | N |
| 2 | DictionaryId | dictionaryId | 字典编号 | bigint | 19 |  |  | N | N | N |
| 3 | ParentId | parentId | 父节点主键 | bigint | 19 |  | 0 | N | N | N |
...
| 11 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 15 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 20 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 3 | EventId | eventId | 事件编号 | bigint | 19 |  |  | N | N | Y |
...
| 18 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 22 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 27 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Id | id | 主键 | bigint | 19 |  |  | Y | Y | N |
| 2 | CompanyId | companyId | 公司主键 | bigint | 19 |  | 0 | N | N | N |
| 3 | UserId | userId | 用户主键 | bigint | 19 |  | 0 | N | N | N |
...
| 16 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 20 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 25 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 4 | UserId | userId | 用户主键 | bigint | 19 |  | 0 | N | N | N |
...
| 8 | CompanyId | companyId | 公司主键 | bigint | 19 |  | 0 | N | N | N |
...
| 24 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 28 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 33 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 8 | Body | body | 正文内容 | nvarchar | 4000 |  |  | N | N | Y |
| 9 | FailCount | failCount | 失败次数 | int | 10 |  | 0 | N | N | Y |
| 10 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 14 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 19 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 26 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 30 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 35 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 7 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 11 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 16 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Id | id | 主键 | bigint | 19 |  |  | Y | Y | N |
| 2 | ParentId | parentId | 父级主键 | bigint | 19 |  | 0 | N | N | N |
...
| 19 | CompanyId | companyId | 所属公司主键 | bigint | 19 |  | 0 | N | N | N |
...
| 48 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 52 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 57 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 5 | PermissionId | permissionId | 有什么权限（模块菜单）主键 | bigint | 19 |  |  | N | N | Y |
...
| 21 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 25 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 30 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 6 | CompanyId | companyId | 公司主键 | bigint | 19 |  | 0 | N | N | N |
...
| 2 | SystemCode | systemCode | 子系统编码 | nvarchar | 50 |  | Base | N | N | N |
| 3 | ResourceCategory | resourceCategory | 什么类型的 | nvarchar | 50 |  |  | N | N | Y |
| 4 | ResourceId | resourceId | 什么资源主键 | bigint | 19 |  |  | N | N | N |
| 5 | TargetCategory | targetCategory | 对什么类型的 | nvarchar | 50 |  |  | N | N | Y |
| 6 | TargetId | targetId | 对什么资源主键 | bigint | 19 |  |  | N | N | N |
| 7 | PermissionId | permissionId | 有什么权限（模块菜单）主键 | bigint | 19 |  |  | N | N | N |
...
| 13 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 17 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 22 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 1 | Id | id | 主键 | bigint | 19 |  |  | Y | Y | N |
| 2 | SystemCode | systemCode | 子系统编码 | nvarchar | 50 |  | Base | N | N | N |
| 3 | OrganizationId | organizationId | 组织机构主键 | bigint | 19 |  | 0 | N | N | N |
...
| 1 | Id | id | 主键 | bigint | 19 |  |  | Y | Y | N |
| 2 | SystemCode | systemCode | 子系统编码 | nvarchar | 50 |  | Base | N | N | N |
| 3 | RoleId | roleId | 角色主键 | bigint | 19 |  | 0 | N | N | N |
| 4 | OrganizationId | organizationId | 组织机构主键 | bigint | 19 |  | 0 | N | N | N |
| 5 | Description | description | 描述 | nvarchar | 4000 |  |  | N | N | Y |
| 6 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 10 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 15 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 5 | Sequence | sequence | 升序序列 | bigint | 19 |  | 10000000 | N | N | N |
| 6 | Reduction | reduction | 倒序序列 | bigint | 19 |  | 9999999 | N | N | N |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Id | id | 主键 | bigint | 19 |  |  | Y | Y | N |
| 2 | UserId | userId | 用户主键 | bigint | 19 |  | 0 | N | N | N |
...
| 9 | CompanyId | companyId | 公司主键 | bigint | 19 |  | 0 | N | N | N |
| 10 | CompanyName | companyName | 公司名称 | nvarchar | 50 |  |  | N | N | Y |
| 11 | SubCompanyId | subCompanyId | 分支机构主键 | bigint | 19 |  | 0 | N | N | N |
| 12 | SubCompanyName | subCompanyName | 子公司名称 | nvarchar | 50 |  |  | N | N | Y |
| 13 | DepartmentId | departmentId | 部门主键 | bigint | 19 |  | 0 | N | N | N |
| 14 | DepartmentName | departmentName | 部门名称 | nvarchar | 50 |  |  | N | N | Y |
| 15 | WorkgroupId | workgroupId | 工作组主键 | bigint | 19 |  | 0 | N | N | N |
| 16 | WorkgroupName | workgroupName | 工作组名称 | nvarchar | 50 |  |  | N | N | Y |
| 17 | DutyId | dutyId | 职位主键 | bigint | 19 |  | 0 | N | N | N |
...
| 92 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 96 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 101 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 1 | Id | id | 编号 | bigint | 19 |  |  | Y | Y | N |
| 2 | SystemCode | systemCode | 子系统编码 | nvarchar | 50 |  | Base | N | N | N |
| 3 | UserCompanyId | userCompanyId | 公司编号 | bigint | 19 |  | 0 | N | N | N |
| 4 | UserSubCompanyId | userSubCompanyId | 子公司编号 | bigint | 19 |  | 0 | N | N | N |
...
| 43 | ManagerUserId | managerUserId | 经理用户编号 | bigint | 19 |  | 0 | N | N | N |
...
| 47 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 51 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 56 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Id | id | 主键 | bigint | 19 |  |  | Y | Y | N |
| 2 | UserId | userId | 用户编号 | bigint | 19 |  | 0 | N | N | N |
...
| 19 | CompanyId | companyId | 公司主键 | bigint | 19 |  | 0 | N | N | N |
...
| 31 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
...
| 35 | CreateUserId | createUserId | 创建人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 40 | UpdateUserId | updateUserId | 修改人编号 | bigint | 19 |  | 0 | N | N | N |
...
| 1 | Id | id | 主键 | bigint | 19 |  |  | Y | Y | N |
| 2 | SystemCode | systemCode | 子系统编码 | nvarchar | 50 |  |  | N | N | Y |
| 3 | UserId | userId | 用户编号 | bigint | 19 |  |  | N | N | N |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Id | id | 主键 | bigint | 19 |  |  | Y | Y | N |
| 2 | UserId | userId | 用户账户主键 | bigint | 19 |  | 0 | N | N | N |
| 3 | CompanyId | companyId | 公司主键 | bigint | 19 |  | 0 | N | N | N |
| 4 | SubCompanyId | subCompanyId | 分支机构主键 | bigint | 19 |  | 0 | N | N | N |
| 5 | DepartmentId | departmentId | 部门主键 | bigint | 19 |  | 0 | N | N | N |
| 6 | SubDepartmentId | subDepartmentId | 子部门主键 | bigint | 19 |  | 0 | N | N | N |
| 7 | WorkgroupId | workgroupId | 工作组主键 | bigint | 19 |  | 0 | N | N | N |
| 8 | Description | description | 描述 | nvarchar | 4000 |  |  | N | N | Y |
| 9 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
| 10 | Deleted | deleted | 是否删除 | tinyint | 3 |  | 0 | N | N | N |
| 11 | Enabled | enabled | 是否有效 | tinyint | 3 |  | 1 | N | N | N |
...
| 1 | Id | id | 主键 | bigint | 19 |  |  | Y | Y | N |
| 2 | SystemCode | systemCode | 子系统编码 | nvarchar | 50 |  | Base | N | N | N |
| 3 | UserId | userId | 用户主键 | bigint | 19 |  |  | N | N | N |
| 4 | RoleId | roleId | 角色主键 | bigint | 19 |  |  | N | N | N |
| 5 | Description | description | 描述 | nvarchar | 4000 |  |  | N | N | Y |
| 6 | SortCode | sortCode | 排序编号 | bigint | 19 |  | 0 | N | N | N |
| 7 | Deleted | deleted | 是否删除 | tinyint | 3 |  | 0 | N | N | N |
| 8 | Enabled | enabled | 是否有效 | tinyint | 3 |  | 1 | N | N | N |
