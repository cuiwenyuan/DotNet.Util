...
namespace DotNet.Business
{
    ...
    public partial class BaseMessageQueueManager : BaseManager, IBaseManager
    {
        ...
        {
            return BaseEntity.Create<BaseMessageQueueEntity>(ExecuteReader(new KeyValuePair<string, object>(PrimaryKey, id)));
            //var cacheKey = CurrentTableName + ".Entity." + id;
            //var cacheTime = TimeSpan.FromMilliseconds(86400000);
            //return CacheUtil.Cache<BaseMessageQueueEntity>(cacheKey, () => BaseEntity.Create<BaseMessageQueueEntity>(ExecuteReader(new KeyValuePair<string, object>(PrimaryKey, id))), true, false, cacheTime);
        }
        ...
        {
            return BaseEntity.Create<BaseMessageQueueEntity>(ExecuteReader(parameters));
        }
