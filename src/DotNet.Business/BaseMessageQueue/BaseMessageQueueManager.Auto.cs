...
namespace DotNet.Business
{
    ...
    public partial class BaseMessageQueueManager : BaseManager, IBaseManager
    {
        ...
        public BaseMessageQueueEntity GetObject(string id)
        {
        ...
        /// </summary>
        /// <param name="id">主键</param>
        public BaseMessageQueueEntity GetObject(int id)
        {
        ...
        /// </summary>
        /// <param name="entity">实体</param>
        public string AddObject(BaseMessageQueueEntity entity)
        {
        ...
        /// </summary>
        /// <param name="entity">实体</param>
        public int UpdateObject(BaseMessageQueueEntity entity)
        {
        ...
        // 这个是声明扩展方法
        partial void SetObjectExpand(SqlBuilder sqlBuilder, BaseMessageQueueEntity entity);
        ...
        /// <param name="entity">实体</param>
        private void SetObject(SqlBuilder sqlBuilder, BaseMessageQueueEntity entity)
        {
