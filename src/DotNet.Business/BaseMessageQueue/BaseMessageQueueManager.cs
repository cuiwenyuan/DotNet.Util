...
namespace DotNet.Business
{
    ...
    public partial class BaseMessageQueueManager : BaseManager, IBaseManager
    {
        ...
        public DataTable GetDataTable(bool myCompanyOnly = true)
        {
            ...
            //return GetDataTable(where, null, new KeyValuePair<string, object>(BaseMessageQueueEntity.FieldEnabled, 1), new KeyValuePair<string, object>(BaseMessageQueueEntity.FieldDeleted, 0));
