...
namespace DotNet.Business
{
    ...
    public partial class BaseMessageFailedManager : BaseManager
    {
        ...
        public BaseMessageFailedManager()
        {
            ...
            CurrentTableDescription = BaseMessageFailedEntity.CurrentTableDescription;
            PrimaryKey = "Id";
        }
        ...
        public BaseMessageFailedEntity GetEntity(List<KeyValuePair<string, object>> parameters, int topLimit = 1, string order = BaseEntity.FieldId + " DESC")
        {
            return BaseEntity.Create<BaseMessageFailedEntity>(GetDataTable(parameters, topLimit, order));
        }
