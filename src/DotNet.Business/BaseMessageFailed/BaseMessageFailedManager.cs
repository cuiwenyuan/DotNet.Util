...
namespace DotNet.Business
{
    ...
    public partial class BaseMessageFailedManager : BaseManager
    {
        ...
        public DataTable GetDataTable(bool myCompanyOnly = true)
        {
            ...
            //return GetDataTable(sb.Put(), null, new KeyValuePair<string, object>(BaseMessageFailedEntity.FieldEnabled, 1), new KeyValuePair<string, object>(BaseMessageFailedEntity.FieldDeleted, 0));
