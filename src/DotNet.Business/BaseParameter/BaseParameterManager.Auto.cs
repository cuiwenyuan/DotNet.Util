...
namespace DotNet.Business
{
    ...
    public partial class BaseParameterManager : BaseManager, IBaseManager
    {
        ...
        {
            return BaseEntity.Create<BaseParameterEntity>(ExecuteReader(new KeyValuePair<string, object>(PrimaryKey, id)));
            //var cacheKey = CurrentTableName + ".Entity." + id;
            //var cacheTime = TimeSpan.FromMilliseconds(86400000);
            //return CacheUtil.Cache<BaseParameterEntity>(cacheKey, () => BaseEntity.Create<BaseParameterEntity>(ExecuteReader(new KeyValuePair<string, object>(PrimaryKey, id))), true, false, cacheTime);
        }
        ...
        {
            return BaseEntity.Create<BaseParameterEntity>(ExecuteReader(parameters));
        }
