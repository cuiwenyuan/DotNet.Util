...
namespace DotNet.Business
{
    ...
    public partial class BaseParameterManager : BaseManager
    {
        ...
        public int Update(BaseParameterEntity entity)
        {
            var result = 0;
            // 检查是否已被其他人修改
            //if (DbUtil.IsModifed(DbHelper, BaseParameterEntity.TableName, parameterEntity.Id, parameterEntity.ModifiedUserId, parameterEntity.ModifiedOn))
            //{
            //    // 数据已经被修改
        ...
        {
            var tableName = BaseParameterEntity.TableName;
