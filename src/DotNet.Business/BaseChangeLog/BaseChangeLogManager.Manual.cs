...
namespace DotNet.Business
{
    ...
    public partial class BaseChangeLogManager : BaseManager
    {
        ...
        /// <returns></returns>
        public DataTable GetDataTableByPage(string tableCode, string tableDescription, string columnCode, string columnDescription, string searchKey, out int recordCount, int pageNo = 1, int pageSize = 20, string sortExpression = BaseUtil.FieldCreateTime, string sortDirection = "DESC")
        {
