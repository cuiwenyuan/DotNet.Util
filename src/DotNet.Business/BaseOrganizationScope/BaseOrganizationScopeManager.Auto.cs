...
namespace DotNet.Business
{
    ...
    public partial class BaseOrganizationScopeManager : BaseManager, IBaseManager
    {
        ...
        {
            return BaseEntity.Create<BaseOrganizationScopeEntity>(ExecuteReader(new KeyValuePair<string, object>(PrimaryKey, id)));
            //var cacheKey = CurrentTableName + ".Entity." + id;
            //var cacheTime = TimeSpan.FromMilliseconds(86400000);
            //return CacheUtil.Cache<BaseOrganizationScopeEntity>(cacheKey, () => BaseEntity.Create<BaseOrganizationScopeEntity>(ExecuteReader(new KeyValuePair<string, object>(PrimaryKey, id))), true, false, cacheTime);
        }
        ...
        {
            return BaseEntity.Create<BaseOrganizationScopeEntity>(ExecuteReader(parameters));
        }
