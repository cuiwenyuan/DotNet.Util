...
namespace DotNet.Business
{
    ...
    public partial class BaseStaffManager : BaseManager
    {
        ...
        public BaseStaffManager()
        {
            ...
            CurrentTableDescription = typeof(BaseStaffEntity).FieldDescription("CurrentTableName");
            PrimaryKey = "Id";
        }
        ...
        public BaseStaffEntity GetEntity(List<KeyValuePair<string, object>> parameters, int topLimit = 1, string order = BaseEntity.FieldId + " DESC")
        {
            return BaseEntity.Create<BaseStaffEntity>(GetDataTable(parameters, topLimit, order));
        }
