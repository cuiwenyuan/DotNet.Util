...
namespace DotNet.Business
{
    ...
    public partial class BaseUserLogonManager : BaseManager
    {
        ...
        public BaseUserLogonManager()
        {
            ...
            CurrentTableDescription = typeof(BaseUserLogonEntity).FieldDescription("CurrentTableName");
            PrimaryKey = "Id";
        }
        ...
        public BaseUserLogonEntity GetEntity(List<KeyValuePair<string, object>> parameters, int topLimit = 1, string order = BaseEntity.FieldId + " DESC")
        {
            return BaseEntity.Create<BaseUserLogonEntity>(GetDataTable(parameters, topLimit, order));
        }
