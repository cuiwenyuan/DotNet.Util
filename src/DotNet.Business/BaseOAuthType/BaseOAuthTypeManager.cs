//-----------------------------------------------------------------------
// <copyright file="BaseOAuthTypeManager.cs" company="DotNet">
...
namespace DotNet.Business
{
    ...
    public partial class BaseOAuthTypeManager : BaseManager, IBaseManager
    {
        ...
        public DataTable GetDataTable(bool myCompanyOnly = true)
        {
            ...
            if (myCompanyOnly)
            {
                //sb.Append("(" + BaseOAuthTypeEntity.FieldUserCompanyId + " = 0 OR " + BaseOAuthTypeEntity.FieldUserCompanyId + " = " + UserInfo.CompanyId + ")");
            }
            //return GetDataTable(where, null, new KeyValuePair<string, object>(BaseOAuthTypeEntity.FieldEnabled, 1), new KeyValuePair<string, object>(BaseOAuthTypeEntity.FieldDeleted, 0));
            ...
            return CacheUtil.Cache<DataTable>(cacheKey, () => GetDataTable(sb.Put(), null, new KeyValuePair<string, object>(BaseOAuthTypeEntity.FieldEnabled, 1), new KeyValuePair<string, object>(BaseOAuthTypeEntity.FieldDeleted, 0)), true, false, cacheTime);
        }
