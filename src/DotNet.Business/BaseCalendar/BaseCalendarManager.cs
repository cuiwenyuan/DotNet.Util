...
namespace DotNet.Business
{
    ...
    public partial class BaseCalendarManager : BaseManager, IBaseManager
    {
        ...
        public DataTable GetDataTable(bool myCompanyOnly = true)
        {
            ...
            //return GetDataTable(where, null, new KeyValuePair<string, object>(BaseCalendarEntity.FieldEnabled, 1), new KeyValuePair<string, object>(BaseCalendarEntity.FieldDeleted, 0));
