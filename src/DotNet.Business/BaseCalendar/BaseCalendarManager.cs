...
namespace DotNet.Business
{
    ...
    public partial class BaseCalendarManager : BaseManager
    {
        ...
        public DataTable GetDataTable(bool myCompanyOnly = true)
        {
            ...
            //return GetDataTable(sb.Put(), null, new KeyValuePair<string, object>(BaseCalendarEntity.FieldEnabled, 1), new KeyValuePair<string, object>(BaseCalendarEntity.FieldDeleted, 0));
            ...
            return CacheUtil.Cache<DataTable>(cacheKey, () => GetDataTable(sb.Put(), null, new KeyValuePair<string, object>(BaseCalendarEntity.FieldEnabled, 1), new KeyValuePair<string, object>(BaseCalendarEntity.FieldDeleted, 0)), true, false, cacheTime);
        }
