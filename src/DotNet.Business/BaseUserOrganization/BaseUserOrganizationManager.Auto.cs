...
namespace DotNet.Business
{
    ...
    public partial class BaseUserOrganizationManager : BaseManager, IBaseManager
    {
        ...
        public string AddEntity(BaseUserOrganizationEntity entity)
        {
            ...
            if (UserInfo != null)
            {
                sqlBuilder.SetValue(BaseUserOrganizationEntity.FieldCreateUserId, UserInfo.UserId);
            ...
            if (UserInfo != null)
            {
                sqlBuilder.SetValue(BaseUserOrganizationEntity.FieldUpdateUserId, UserInfo.UserId);
