...
namespace DotNet.Business
{
    ...
    public partial class BaseLogonLogManager : BaseManager
    {
        ...
        public BaseLogonLogManager()
        {
            ...
            CurrentTableDescription = BaseLogonLogEntity.CurrentTableDescription;
            PrimaryKey = "Id";
        }
        ...
        public BaseLogonLogEntity GetEntity(List<KeyValuePair<string, object>> parameters, int topLimit = 1, string order = BaseEntity.FieldId + " DESC")
        {
            return BaseEntity.Create<BaseLogonLogEntity>(GetDataTable(parameters, topLimit, order));
        }
