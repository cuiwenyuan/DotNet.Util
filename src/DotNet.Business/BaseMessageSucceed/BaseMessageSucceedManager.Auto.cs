...
namespace DotNet.Business
{
    ...
    public partial class BaseMessageSucceedManager : BaseManager
    {
        ...
        public BaseMessageSucceedManager()
        {
            ...
            CurrentTableDescription = BaseMessageSucceedEntity.CurrentTableDescription;
            PrimaryKey = "Id";
        }
        ...
        public BaseMessageSucceedEntity GetEntity(List<KeyValuePair<string, object>> parameters, int topLimit = 1, string order = BaseEntity.FieldId + " DESC")
        {
            return BaseEntity.Create<BaseMessageSucceedEntity>(GetDataTable(parameters, topLimit, order));
        }
