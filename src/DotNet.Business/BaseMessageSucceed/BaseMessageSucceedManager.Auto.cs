...
namespace DotNet.Business
{
    ...
    public partial class BaseMessageSucceedManager : BaseManager, IBaseManager
    {
        ...
        public BaseMessageSucceedEntity GetObject(string id)
        {
        ...
        /// </summary>
        /// <param name="id">主键</param>
        public BaseMessageSucceedEntity GetObject(int id)
        {
        ...
        /// </summary>
        /// <param name="entity">实体</param>
        public string AddObject(BaseMessageSucceedEntity entity)
        {
        ...
        /// </summary>
        /// <param name="entity">实体</param>
        public int UpdateObject(BaseMessageSucceedEntity entity)
        {
        ...
        // 这个是声明扩展方法
        partial void SetObjectExpand(SqlBuilder sqlBuilder, BaseMessageSucceedEntity entity);
        ...
        /// <param name="entity">实体</param>
        private void SetObject(SqlBuilder sqlBuilder, BaseMessageSucceedEntity entity)
        {
