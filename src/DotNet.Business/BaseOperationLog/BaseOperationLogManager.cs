...
namespace DotNet.Business
{
    ...
    public partial class BaseOperationLogManager : BaseManager, IBaseManager
    {
        ...
        public DataTable GetDataTable(bool myCompanyOnly = true)
        {
            ...
            //return GetDataTable(sb.Put(), null, new KeyValuePair<string, object>(BaseOperationLogEntity.FieldEnabled, 1), new KeyValuePair<string, object>(BaseOperationLogEntity.FieldDeleted, 0));
            ...
            return CacheUtil.Cache<DataTable>(cacheKey, () => GetDataTable(sb.Put(), null, new KeyValuePair<string, object>(BaseOperationLogEntity.FieldEnabled, 1), new KeyValuePair<string, object>(BaseOperationLogEntity.FieldDeleted, 0)), true, false, cacheTime);
        }
