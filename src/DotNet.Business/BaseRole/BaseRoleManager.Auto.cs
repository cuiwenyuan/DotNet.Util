...
namespace DotNet.Business
{
    ...
    public partial class BaseRoleManager : BaseManager, IBaseManager
    {
        ...
        {
            return BaseEntity.Create<BaseRoleEntity>(ExecuteReader(new KeyValuePair<string, object>(PrimaryKey, id)));
            //var cacheKey = CurrentTableName + ".Entity." + id;
            //var cacheTime = TimeSpan.FromMilliseconds(86400000);
            //return CacheUtil.Cache<BaseRoleEntity>(cacheKey, () => BaseEntity.Create<BaseRoleEntity>(ExecuteReader(new KeyValuePair<string, object>(PrimaryKey, id))), true, false, cacheTime);
        }
