...
namespace DotNet.Business
{
    ...
    public partial class BaseRoleManager : BaseManager
    {
        ...
        public BaseRoleManager()
        {
            ...
            CurrentTableDescription = typeof(BaseRoleEntity).FieldDescription("CurrentTableName");
            PrimaryKey = "Id";
        }
        ...
        public BaseRoleEntity GetEntity(List<KeyValuePair<string, object>> parameters, int topLimit = 1, string order = BaseEntity.FieldId + " DESC")
        {
            return BaseEntity.Create<BaseRoleEntity>(GetDataTable(parameters, topLimit, order));
        }
