...
namespace DotNet.Business
{
    ...
    public partial class BaseManager : IBaseManager
    {
        ...
        /// <returns>数据表</returns>
        public virtual DataTable GetTableSpaceByPage(string searchKey, out int recordCount, int pageIndex = 0, int pageSize = 20, string sortExpression = "Id", string sortDirection = "DESC")
        {
            pageIndex++;
            ...
            sb.Replace(" 1 = 1 AND ", "");
            return GetDataTableByPage(out recordCount, pageIndex, pageSize, sortExpression, sortDirection, sb.Put(), null, null, "*");
        }
        #endregion
    }
}