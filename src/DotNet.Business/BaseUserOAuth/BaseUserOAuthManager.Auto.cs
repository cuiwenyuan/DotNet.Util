...
namespace DotNet.Business
{
    ...
    public partial class BaseUserOAuthManager : BaseManager
    {
        ...
        public BaseUserOAuthManager()
        {
            ...
            CurrentTableDescription = BaseUserOAuthEntity.CurrentTableDescription;
            PrimaryKey = "Id";
        }
        ...
        public BaseUserOAuthEntity GetEntity(List<KeyValuePair<string, object>> parameters, int topLimit = 1, string order = BaseEntity.FieldId + " DESC")
        {
            return BaseEntity.Create<BaseUserOAuthEntity>(GetDataTable(parameters, topLimit, order));
        }
