...
namespace DotNet.Business
{
    ...
    public partial class BaseUserManager : BaseManager
    {
        ...
        public DataTable DailyUserReport(int days, string startDate, string endDate)
        {
            ...
            sql += " ,(SELECT COUNT(*) FROM " + BaseOrganizeEntity.TableName + " A WHERE DATEDIFF(d,A.CreateOn,B.TransactionDate) = 0 AND A.Enabled = 1 AND A." + BaseOrganizeEntity.FieldDeleted + " = 0 AND ParentId IS NULL) AS TotalCompanyCount";
