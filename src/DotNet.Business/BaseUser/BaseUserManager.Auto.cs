...
namespace DotNet.Business
{
    ...
    public partial class BaseUserManager : BaseManager, IBaseManager
    {
        ...
        {
            return BaseEntity.Create<BaseUserEntity>(ExecuteReader(new KeyValuePair<string, object>(PrimaryKey, id)));
            //var cacheKey = CurrentTableName + ".Entity." + id;
            //var cacheTime = TimeSpan.FromMilliseconds(86400000);
            //return CacheUtil.Cache<BaseUserEntity>(cacheKey, () => BaseEntity.Create<BaseUserEntity>(ExecuteReader(new KeyValuePair<string, object>(PrimaryKey, id))), true, false, cacheTime);
        }
        ...
        {
            return BaseEntity.Create<BaseUserEntity>(ExecuteReader(parameters));
        }
