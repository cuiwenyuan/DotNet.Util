...
namespace DotNet.Business
{
    ...
    public partial class BaseUserService : IBaseUserService
    {
        ...
        public bool Exists(BaseUserInfo userInfo, List<KeyValuePair<string, object>> parameters, string id)
        {
            ...
            {
                var manager = new BaseManager(dbHelper, userInfo, BaseUserEntity.CurrentTableName);
        ...
        /// <param name="id">主键</param>
        /// <returns>实体</returns>
        public BaseUserContactEntity GetUserContactObject(BaseUserInfo userInfo, int id)
        {
            ...
            ServiceUtil.ProcessUserCenterReadDb(userInfo, parameter, (dbHelper) =>
            {
                ...
                {
                    var userContactManager = new BaseUserContactManager(dbHelper, userInfo);
                    entity = userContactManager.GetEntityByUserId(id);
                }
            });
        ...
        /// <param name="id">主键</param>
        /// <returns>实体</returns>
        public BaseUserContactEntity GetUserContactObjectByCache(BaseUserInfo userInfo, int id)
        {
            BaseUserContactEntity entity = null;
        ...
        #region public List<BaseUserEntity> GetListByManager(BaseUserInfo userInfo, string managerUserId) 按上级主管获取下属用户列表
        /// <summary>
        /// 按上级主管获取下属用户列表
        /// </summary>
        /// <param name="userInfo">用户信息</param>
        ...
        public List<BaseUserEntity> GetListByManager(BaseUserInfo userInfo, string managerUserId)
        {
            var result = new List<BaseUserEntity>();
            ...
            {
                var userManager = new BaseUserManager(dbHelper, userInfo);
                result = userManager.GetListByManager(managerUserId);
            });
        ...
        #region public string[] GetIdsByManager(string managerUserId) 按上级主管获取下属用户主键数组
        /// <summary>
        /// 按上级主管获取下属用户主键数组
        /// </summary>
        /// <param name="userInfo">用户信息</param>
        ...
        public string[] GetIdsByManager(BaseUserInfo userInfo, string managerUserId)
        {
            string[] result = null;
            ...
            {
                var userManager = new BaseUserManager(dbHelper, userInfo);
                result = userManager.GetIdsByManager(managerUserId);
            });
        ...
        #region public DataTable GetDataTableByPage(BaseUserInfo userInfo, out int recordCount, int pageNo, int pageSize, string condition, List<KeyValuePair<string, object>> dbParameters, string order = null)
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="userInfo">用户</param>
