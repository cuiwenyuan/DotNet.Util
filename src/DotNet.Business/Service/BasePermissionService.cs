...
namespace DotNet.Business
{
    ...
    public partial class BasePermissionService : IBasePermissionService
    {
        ...
        {
            return IsAuthorized(userInfo, userInfo.Id.ToString(), permissionCode, permissionName);
        }
        #endregion
        ...
        {
            return IsAdministratorByUser(userInfo, userInfo.Id.ToString());
        }
        #endregion
        ...
        public string[] GetPermissionIds(BaseUserInfo userInfo, string systemCode, string userId)
        {
            ...
            ServiceUtil.ProcessUserCenterReadDb(userInfo, parameter, (dbHelper) =>
            {
                ...
                result = permissionManager.GetPermissionIdsByUser(systemCode, userId, companyId: string.Empty, containPublic: true, useBaseRole: false);
            });
        ...
        {
            return GetPermissionListByUser(userInfo, userInfo.SystemCode, userInfo.Id.ToString(), userInfo.CompanyId, fromCache);
        }
        #endregion
        ...
        {
            return IsModuleAuthorizedByUser(userInfo, userInfo.Id.ToString(), moduleCode);
        }
        #endregion
