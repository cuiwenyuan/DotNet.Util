...
namespace DotNet.Util
{
    ...
    /// <summary>CRC32校验 - 来自NewLife</summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class Crc32Util //: HashAlgorithm
    {
        ...
        public Crc32Util Reset() { crc = CrcSeed; return this; }

        /// <summary>添加整数进行校验</summary>
        /// <param name = "value">
        /// the byte is taken as the lower 8 bits of value
        /// </param>
        public Crc32Util Update(Int32 value)
        {
        ...
        /// </param>
        public Crc32Util Update(Byte[] buffer, Int32 offset = 0, Int32 count = -1)
        {
        ...
        public Crc32Util Update(Stream stream, Int64 count = -1)
        {
