...
{
    /// <summary>抽象语法标记。ASN.1是一种 ISO/ITU-T 标准，描述了一种对数据进行表示、编码、传输和解码的数据格式。 - 来自NewLife</summary>
    public class Asn1Util
    {
        ...
        public override String ToString()
        {
            switch (Tag)
            {
                ...
                case Asn1Tags.Sequence:
                    if (Value is Asn1Util[] arr) return arr.Join();
                    break;
            }
        ...
        /// <returns></returns>
        public static Asn1Util Read(Byte[] data) => Read(new BinaryReader(new MemoryStream(data)));

        /// <summary>读取</summary>
        /// <param name="stream"></param>
        /// <returns></returns>
        public static Asn1Util Read(Stream stream) => Read(new BinaryReader(stream));
        ...
        public static Asn1Util Read(BinaryReader reader)
        {
            ...
            var asn = new Asn1Util { Length = len };
