...
{
    /// <summary>CRC16校验 - 来自NewLife</summary>
    public sealed class Crc16Util
    {
        #region 数据表
        ...
        public Crc16Util Reset() { Value = 0xFFFF; return this; }

        /// <summary>添加整数进行校验</summary>
        /// <param name = "value">
        /// the byte is taken as the lower 8 bits of value
        /// </param>
        public Crc16Util Update(Int16 value)
        {
        ...
        public Crc16Util Update(Byte[] buffer, Int32 offset = 0, Int32 count = -1)
        {
        ...
        public Crc16Util Update(Stream stream, Int64 count = -1)
        {
