...
namespace DotNet.Util
{
    ...
    public partial class RmbUtil
    {
        ...
        public static string Capital(decimal num)
        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (j >= 11)
                                {
                                    //修复：万位为0但万组（低4位）内有非零数字时，仍需输出“万”
                                    var shouldOutputWan = false;
                                    if (i == j - 7)
                                    {
                                        for (var k = j - 11; k < j - 7; k++)
                                        {
                                            if (k >= 0 && str4[k] != '0')
                                            {
                                                shouldOutputWan = true;
                                                break;
                                            }
                                        }
                                    }
