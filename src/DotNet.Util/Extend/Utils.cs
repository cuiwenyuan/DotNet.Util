...
namespace DotNet.Util
{
    ...
    public partial class Utils
    {
        ...
        //    str = str.ToLower();
        //    var stringArray = Utils.SplitString(stringarray.ToLower(), strsplit);
        ...
        //    var byteLen = System.Text.Encoding.Default.GetByteCount(str);// 单字节字符长度
        ...
        //{
        //    var userip = Utils.SplitString(ip, @".");

        //    for (var ipIndex = 0; ipIndex < iparray.Length; ipIndex++)
        //    {
        //        var tmpip = Utils.SplitString(iparray[ipIndex], @".");
        //        var r = 0;
        ...
        //    var cookie = HttpContext.Request.Cookies.TryGetValue[strName];
        //    if (cookie == null)
        //    {
        //        cookie = new HttpCookie(strName);
        //    }
        ...
        //{
        //    var regEx = new System.Text.RegularExpressions.Regex(@"</?(?!br|/?p|img)[^>]*>", System.Text.RegularExpressions.RegexOptions.IgnoreCase);
        ...
        //    {
        //        var b = System.Text.Encoding.Unicode.GetBytes(c, i, 1);
        //        if (b.Length == 2)
        //        {
        //            if (b[1] == 255)
        //            {
        ...
        //        foreach (var fieldname in dtField)
        //        {   //对 \ , ' 符号进行转换 
        ...
        //private static string[] _browerNames = { "MSIE", "Firefox", "Opera", "Netscape", "Safari", "Lynx", "Konqueror", "Mozilla" };
        ...
        //    {
        //        foreach (var name in _browerNames)
        //        {
        ...
        //        var writer = new System.Xml.XmlTextWriter(Utils.GetMapPath("~/web.config"), null);
